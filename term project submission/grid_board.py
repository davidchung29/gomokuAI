...
class gridBoard():
    ...
    def drawBoard(self, canvas): #https://www.cs.cmu.edu/~112/notes/notes-animations-part2.html - learned how to create a grid with rectangles
    ...
    def drawPieces(self, canvas): #https://www.cs.cmu.edu/~112/notes/notes-graphics.html- learned how to create an oval with the create_oval function 
